...
foreach ($eqLogics as $eqLogic) {
	...
	echo '<img src="plugins/rcswitch2/plugin_info/rcswitch2_icon.png" height="105" width="95" />';
	echo "<br>";
...
echo '<div class="col-lg-2">';
	          ...
	          echo  '<a class="btn btn-default" id="bt_rfsniffer" data-slaveid="-1" data-log="RFsniffer"><i class="fa fa-cog"></i> {{Récupération de code standard}}</a>';
	          echo  '<a class="btn btn-default" id="bt_hereceive" data-slaveid="-1" data-log="HEreceive"><i class="fa fa-cog"></i> {{Récupération de code Homeeasy}}</a>';
...
<?php
include_file('desktop', 'rcswitch2', 'js', 'rcswitch2');
